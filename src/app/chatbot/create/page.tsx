...
function SidebarCard() {
  return (
    <div className="flex flex-col items-center space-y-4 px-8 py-32 ">
      ...
      <p className="text-3xl text-neutral-400 text-center font-bold mb-4">Crea un chatbot facil</p>
      <p className='text-white text-xl text-center'>Puedes crear un chatbot basado en el menu de tu restaurant o bar con el cual tus clientes podran interactuar y pedir productos</p>
    </div>
  )
}
